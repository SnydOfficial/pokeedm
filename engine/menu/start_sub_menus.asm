...
.outOfBattleMovePointers
	...
	dw .softboiled
.fly
	bit 0,a ; does the player have the Thunder Badge?
...
.canFly
	...
	jp StartMenu_Pokemon
.cut
	bit 0,a ; does the player have the Cascade Badge?
	jp z,.newBadgeRequired
	predef UsedCut
	ld a,[wcd6a]
	and a
	...
	jp CloseTextDisplay
.surf
	bit 0,a ; does the player have the Soul Badge?
	jp z,.newBadgeRequired
	...
	jp .goBackToMap
.strength
	bit 0,a ; does the player have the Rainbow Badge?
	jp z,.newBadgeRequired
