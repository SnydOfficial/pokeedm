...
PokemonTower6TextPointers: ; 60bb1 (18:4bb1)
	...
	dw PokemonTower6TextFlute1
	dw PokemonTower6TextFlute2
	dw PokemonTower6TextFlute3
...
PokemonTower6Text4: ; 60bf8 (18:4bf8)
	db $08 ; asm
	ld a, [wd76c]
	bit 0, a
	jr nz, .asm_15ac2 ; 0x1d91e
	ld hl, PokemonTower6TextFlute1
	call PrintText
	ld bc, (POKE_FLUTE << 8) | 1
	call GiveItem
	jr nc, .BagFull
	ld hl, PokemonTower6TextFlute2
	call PrintText
	ld hl, wd76c
	set 0, [hl]
	ld a, HS_POKEMONTOWER_6_ITEM_1
	ld [wcc4d], a
	predef HideObject
	ld hl, wd7e0
	set 7, [hl]
...
PokemonTower6TextFlute1: ; 60c56 (18:4c56)
	TX_FAR _PokemonTower6TextFlute1
	db "@"
	
PokemonTower6TextFlute2: ; 60c56 (18:4c56)
	TX_FAR _PokemonTower6TextFlute2
	db "@"
	
PokemonTower6TextFlute3: ; 60c56 (18:4c56)
	TX_FAR _PokemonTower6TextFlute3
	db "@"
