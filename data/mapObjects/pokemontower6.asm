PokemonTower6Object: ; 0x60c5b (size=58)
	...
	db $5 ; people
	db SPRITE_MEDIUM, $9 + 4, $f + 4, $ff, $d3, TRAINER | $1, CHANNELER + $C8, $13
	db SPRITE_MEDIUM, $c + 4, $8 + 4, $ff, $d0, TRAINER | $2, CHANNELER + $C8, $14
	db SPRITE_MEDIUM, $5 + 4, $6 + 4, $ff, $d2, TRAINER | $3, CHANNELER + $C8, $15
	db SPRITE_BALL, $2 + 4, $a + 4, $ff, $ff, ITEM | $4, POKE_FLUTE
