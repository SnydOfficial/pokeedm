PokemonTower4Object: ; 0x6088b (size=65)
	...
	db $6 ; people
	db SPRITE_MEDIUM, $8 + 4, $a + 4, $ff, $d3, TRAINER | $1, CHANNELER + $C8, $9
	db SPRITE_MEDIUM, $7 + 4, $f + 4, $ff, $d0, TRAINER | $2, CHANNELER + $C8, $a
	db SPRITE_MEDIUM, $d + 4, $b + 4, $ff, $d2, TRAINER | $3, CHANNELER + $C8, $c
	db SPRITE_BALL, $1 + 4, $9 + 4, $ff, $ff, ITEM | $4, ELIXER
	db SPRITE_BALL, $1 + 4, $c + 4, $ff, $ff, ITEM | $5, AWAKENING
