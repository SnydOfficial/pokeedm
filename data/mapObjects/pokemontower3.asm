PokemonTower3Object: ; 0x6075d (size=51)
	...
	db $4 ; people
	db SPRITE_MEDIUM, $4 + 4, $c + 4, $ff, $d2, TRAINER | $1, CHANNELER + $C8, $5
	db SPRITE_MEDIUM, $8 + 4, $9 + 4, $ff, $d0, TRAINER | $2, CHANNELER + $C8, $6
	db SPRITE_MEDIUM, $d + 4, $b + 4, $ff, $d0, TRAINER | $3, CHANNELER + $C8, $8
	db SPRITE_BALL, $2 + 4, $c + 4, $ff, $ff, ITEM | $4, ESCAPE_ROPE
