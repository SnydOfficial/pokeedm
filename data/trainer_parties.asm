TrainerDataPointers: ; 39d3b (e:5d3b)
	...
	dw AgathaData,LanceData,KarmaData,EmmaData,ChrisData,LeeData,FinnData
	dw GeorgeData,MikeData,BenData
...
YoungsterData: ; 39d99 (e:5d99)
	...
	db 15,RATTATA,EKANS,SLOWPOKE,0
...
LassData: ; 39e0c (e:5e0c)
	...
	db 14,JIGGLYPUFF,0
	db 12,SANDSHREW,SPEAROW,EKANS,0
...
if DEF(_YELLOW)
	...
	db 11,PARAS,VENONAT,0
endc
	db 20,PIKACHU,RAICHU,0
	db 19,STARYU,0
	db 20,SQUIRTLE,0
...
BikerData: ; 39f9c (e:5f9c)
	...
	db 18,WEEZING,0
	db 16,GRIMER,GRIMER,GRIMER,GRIMER,0
...
CueBallData: ; 3a08d (e:608d)
	db 17,MACHOP,MANKEY,MACHOP,0
	db 18,MANKEY,MACHOP,0
	db 18,MACHOP,0
...
if DEF(_YELLOW)
	...
	db $FF,14,PIDGEOTTO,15,ABRA,15,RATTATA,15,SQUIRTLE,0
	db $FF,14,PIDGEOTTO,15,ABRA,15,RATTATA,15,BULBASAUR,0
	db $FF,14,PIDGEOTTO,15,ABRA,15,RATTATA,15,CHARMANDER,0
endc
...
if DEF(_YELLOW)
	...
	db $FF,25,RATICATE,24,RHYHORN,29,KANGASKHAN,0
	db $FF,37,RATICATE,35,KANGASKHAN,37,RHYHORN,41,NIDOQUEEN,0
	db $FF,45,RATICATE,42,DUGTRIO,44,NIDOQUEEN,45,NIDOKING,50,RHYDON,0
endc
...
if DEF(_YELLOW)
	...
	db $FF,11,BUTTERFREE,12,BEEDRILL,0
endc
MistyData: ; 3a3bb (e:63bb)
	db $FF,28,POLIWAG,31,PIKABLU,0
...
ChannelerData: ; 3a4c7 (e:64c7)
	...
	db 17,CHARMELEON,0
	db 18,PIKACHU,0
	db 15,CHARMANDER,SQUIRTLE,BULBASAUR,0
	db 17,PIKACHU,0
	db 17,PIKACHU,0
...
KarmaData: ; 3a522 (e:6522)
	db $FF,35,RAICHU,35,SNORLAX,35,GENGAR,35,MEWTWO,35,AFROCHAN,35,AFROLEE,0
EmmaData: ; 3a522 (e:6522)
	db $FF,30,BULBASAUR,30,NINETALES,30,ARCANINE,30,DRAGONITE,0
ChrisData: ; 3a522 (e:6522)
	db $FF,30,WARTORTLE,30,CHARMELEON,30,IVYSAUR,30,PIKACHU,0
LeeData: ; 3a522 (e:6522)
	db $FF,30,SNORLAX,30,GYARADOS,30,CHARIZARD,30,GOLDUCK,0
FinnData: ; 3a522 (e:6522)
	db $FF,30,MAGMAR,30,PIKAFLARE,30,RAPIDASH,30,FLAREON,0
GeorgeData: ; 3a522 (e:6522)
	db $FF,25,PIDGEOT,25,FEAROW,25,FARFETCH_D,25,SCYTHER,0
MikeData: ; 3a522 (e:6522)
	db $FF,20,RAPIDASH,23,CUBONE,25,PERSIAN,25,WIGGLYTUFF,0
BenData: ; 3a522 (e:6522)
	db $FF,20,SLOWBRO,23,GOLBAT,25,PRIMEAPE,25,CLEFABLE,0