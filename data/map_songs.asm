MapSongBanks: ; c04d (3:404d)
	db MUSIC_GAME_CORNER, BANK(Music_GameCorner) ;PALLET_TOWN
	...
	db MUSIC_ROUTES4, BANK(Music_Routes4) ; SSAnne1
	db MUSIC_GAME_CORNER, BANK(Music_GameCorner) ; RedsHouse1F
	db MUSIC_GAME_CORNER, BANK(Music_GameCorner) ; RedsHouse2F
	db MUSIC_GAME_CORNER, BANK(Music_GameCorner) ; BluesHouse
	...
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; SSAnne7
	...
	db MUSIC_CITIES1, BANK(Music_Cities1) ;newcity
	db MUSIC_POKECENTER, BANK(Music_Pokecenter) ;newcitypokecenter
	db MUSIC_BIKE_RIDING, BANK(Music_BikeRiding) ;unused
