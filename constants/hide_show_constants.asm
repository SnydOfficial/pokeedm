...
const_value = 0
	...
	const HS_VIRIDIAN_FOREST_GUY_1
	...
	const HS_CERULEAN_GYM_1
	const HS_CERULEAN_GYM_2
	const HS_CERULEAN_GYM_3
	const HS_SS_ANNE_2_RIVAL              ; 71
	const HS_SS_ANNE_7_GIRL_1              ; 71
	const HS_SS_ANNE_7_GIRL_2              ; 71
